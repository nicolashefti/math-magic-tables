...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    query: function(relativeSelectors) {
      return document.querySelector(relativeSelectors);
    },
    HtmlElement: {
      "^": "Element;",
      $isHtmlElement: 1,
  ...
  }], ["sunflower", "main.dart",, B, {
    "^": "",
    main: [function() {
      var t1 = J.get$onChange$x($.get$inputModulo());
      ...
      t1 = J.get$onChange$x($.get$inputFactor());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.main_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      B.draw();
    }, "call$0", "main$closure", 0, 0, 1],
    draw: function() {
      var t1, i, t2, theta, t3, thetaFactor, t4, t5;
      $.modulo = H.Primitives_parseInt(J.get$value$x($.get$inputModulo()), null, null);
      $.factor = H.Primitives_parseInt(J.get$value$x($.get$inputFactor()), null, null);
      t1 = $.get$context();
      ...
      while (true) {
        ...
        if (!(i < t2))
          break;
        theta = 6.283185307179586 * i / t2 - 1.5707963267948966;
        t3 = $.factor;
        if (typeof t3 !== "number")
          return H.iae(t3);
        thetaFactor = 6.283185307179586 * C.JSNumber_methods.$mod(i * t3, t2) / t2 - 1.5707963267948966;
        t2 = 150 + 100 * Math.cos(theta);
        t3 = 150 + 100 * Math.sin(theta);
        t4 = Math.cos(thetaFactor);
        t5 = Math.sin(thetaFactor);
        t1.beginPath();
        t1.lineWidth = 2;
        t1.fillStyle = "#D2D2D2";
        t1.strokeStyle = "#D2D2D2";
        t1.arc(t2, t3, 2, 0, 6.283185307179586, false);
        t1.fill("nonzero");
        t1.closePath();
        t1.stroke();
        t1.beginPath();
        t1.lineWidth = 1;
        t1.fillStyle = "#C2C2C2";
        t1.strokeStyle = "#C2C2C2";
        t1.moveTo(t2, t3);
        t1.lineTo(150 + 100 * t4, 150 + 100 * t5);
        t1.closePath();
        t1.stroke();
        ++i;
      }
...
;
  ...
  (function(lazies) {
    ...
    return [];
  }, "_toStringVisiting", "inputModulo", "get$inputModulo", function() {
    return W.query("#modulo");
  }, "inputModulo", "inputFactor", "get$inputFactor", function() {
    return W.query("#factor");
  }, "inputFactor", "context", "get$context", function() {
    var t1 = H.interceptedTypeCast(W.query("#canvas"), "$isCanvasElement");
    t1.toString;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}];
